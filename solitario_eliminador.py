...
class SolitarioEliminador:
    ...
    def armar(self):
        ...
        for i in range(CANT_FUNDACIONES):
            # Creamos 6 fundaciones, una para cada palo, no más restricciones
    ...
    def jugar(self, jugada):
        ...
        elif len(jugada) == 2 and j0 == PILA_TABLERO:
            # Permite elegir la fundación a la cual se quiere mover la carta.
            destino = self.mesa.fundaciones[p1]
